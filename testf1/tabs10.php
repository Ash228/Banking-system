...
<head>
  ...
  ?>
    ...
    <br>
  <?php if(strcmp($row1[2], "Male")==0) { echo '<img src="male.jpg" alt="profile" class="w3-center" style="padding-left: 40px">'; }
        else { echo '<img src="female.jpg" alt="profile" class="w3-center" style="padding-left: 40px" >';} ?><br><br>
